    ...
    <div className="bg-white rounded border border-vne-border shadow-sm relative">
        ...
        <div className="flex justify-between items-center mb-3">
            ...
            <div className="flex bg-gray-100 p-0.5 rounded-md">
                <button
                    ...
                    className={`px-3 py-1 rounded-[4px] flex items-center gap-1.5 text-xs font-bold transition-all ${
                ...
                <button
                    ...
                    className={`px-3 py-1 rounded-[4px] flex items-center gap-1.5 text-xs font-bold transition-all ${
                        viewMode === 'MAP' ? 'bg-white shadow-sm text-vne-red' : 'text-gray-500 hover:text-gray-700'
                    }`}
                >
      ...
      {viewMode === 'LIST' ? (
        ...
        <div className="p-3 animate-in fade-in duration-300">
             <div className="mb-2 text-xs text-gray-600 bg-gray-50 p-2 rounded border border-gray-100">
                <span className="text-vne-red font-bold">● Đỏ: Cấm</span> 
                <span className="mx-2 text-gray-300">|</span>
                <span className="text-orange-600 font-bold">● Cam: Hạn chế</span>
            </div>
            <HanoiMap />
        </div>
      )}
